...
import { 
  TreePine, Eye, FileText, Recycle, Flame, Ruler, Footprints, 
  Church, Building2, Leaf, Shield, Users, Bird, ChevronDown,
    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="home" className="relative h-screen min-h-[600px] flex items-center justify-center text-center text-white pt-20">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 drop-shadow-lg leading-tight">
            Les u Kladna v ohrožení – opakující se černá skládka
          </h1>
          ...
          <div className="space-y-12">
            {[
              ...
              <div key={idx} className="relative flex items-start gap-8">
                <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-0.5 bg-[#4a7c2c]" />
          ...
          <div className="max-w-3xl mx-auto text-center">
            <div className="bg-gradient-to-br from-[#2d5016] to-[#4a7c2c] p-8 rounded-lg shadow-xl text-white mb-8">
              ...
              <p className="text-lg mb-6 opacity-90">
                Veškerá fotodokumentace černé skládky, nelegálního pobytu, požáru a úklidových akcí je volně dostupná na Google Disku. Fotografie dokumentují závažnost situace a jsou k dispozici pro média, úřady i veřejnost.
              </p>
              <a
                href="https://drive.google.com/drive/folders/1mgzH9geW9sDTxL8pHUWV_cPxMy_sPE5i?usp=sharing"
                target="_blank"
                rel="noopener noreferrer"
      ...
      <section id="media" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
            O problému černé skládky u Kladna již informovala řada médií. Přinášíme přehled článků, které dokumentují závažnost situace a upozorňují veřejnost na trvajíc problém.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              {
                title: 'U Kožovky v sobotu ráno hořely odpadky v lese. Požár pravdepodobně založil známý bezdomovec, který zde žije',
                media: 'NáŠeKladno.cz',
                date: '12. dubna 2025',
                excerpt: 'V sobotu ráno zasahovali hasiči u požáru v lese u Kožovky. Hořely odpadky a igelitové tašky nashromážděné bezdomovcem, který v lokalitě dlouhodobě pobývá. Požár pravdepodobně založil sám.',
              ...
              },
              {
                ...
                date: '7. ledna 2026',
                excerpt: 'Strážníci Městské policie Kladno zajiťovali pořádek a dohled při úklidu lesa v lokalitě Kožovy. Akce probíhala ve spolupráci s odpadovou firmou AVE Kladno. Muži žijícímu na pozemku byla opakovaně nabídnuta sociální pomoc.',
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-600 mb-4">
              Jste novinář a chcete o situaci psát? Kontaktujte nás pro více informací a fotodokumentaci.
            </p>
            <a
      ...
      <section id="actors" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: Church, title: 'Benediktinské arciopatství sv. Vojtěcha a sv. Markéty', role: 'Vlastník pozemku', desc: 'Zodpovídá za údržbu a zabezpečení svého majetku. Dosud nebylo přijato technické opatření proti opakovanému znečištění.', link: 'brevnov.cz' },
              { icon: Building2, title: 'Město Kladno', role: 'Místní samospráva', desc: 'Sporadicky se podílí na úklidu pozemku, avšak bez systémového řešení problému. Má pravomoc zapojit sociální služby a zvýšit kontrolu.', link: 'mestokladno.cz' },
              { icon: Leaf, title: 'ČIŽP', role: 'Česká inspekce životního prostředí', desc: 'Česká inspekce životního prostředí má pravomoc šetřit opakované porušování zákona o odpadech a uložit sankce.', link: 'cizp.cz' },
              { icon: Shield, title: 'Policie ČR / MP Kladno', role: 'Dozor a pořádková pravomoc', desc: 'Má pravomoc kontrolovat dodržování veřejného pořádku a spolupracovat s dalšími orgány při řešení nelegálního pobytu a černé skládky.', link: 'policie.cz' },
              { icon: Users, title: 'Místní obyvatelé', role: 'Nejvíce postižení', desc: 'Lidé žijící v okolí pociťují negativní dopady na kvalitu života, obavy o bezpečnost dětí a zhoršenou estetiku krajiny pro rekreaci.' },
              { icon: Bird, title: 'Příroda a zvěř', role: 'Němí postižení', desc: 'Kontaminace půdy, ohrožení zvířat požárem a chemikáliemi, narušení ekosystému a přirozených stanovišť volně žijících živočichů.' }
            ].map((actor, idx) => (
              <div key={idx} className="bg-white p-6 rounded-lg shadow-lg hover:-translate-y-2 transition-all text-center">
                ...
                {actor.link && (
                  <a href={`https://${actor.link}`} target="_blank" rel="noopener noreferrer" className="text-[#4a7c2c] text-sm hover:underline inline-flex items-center gap-1">
      ...
      <section id="petition" className="py-24 bg-gradient-to-br from-[#2d5016] to-[#4a7c2c] text-white text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Podpořte nás – podepište petici
          </h2>
          <p className="text-lg md:text-xl mb-8 leading-relaxed opacity-95">
            Váš podpis znamená tlak na odpovědné instituce. Pomůžete ochránit přírodu, zajistit důstojné řešení pro všechny zúčastněné a ukázat, že nečinnost není akceptovatelná. Každý hlas se počítá!
          </p>
          <a
            href="https://gov.cz/e-petice/1569-petice-proti-opakovane-cerne-skladce-a-nelegalnimu-znecistovani-lesniho-pozemku-v-lokalite-v-kozovech-u-kladna"
            target="_blank"
      ...
      <footer className="bg-[#2c3e50] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 text-sm opacity-90 leading-relaxed max-w-4xl mx-auto">
            ...
            <p>Petice je realizována v souladu se zákonem č. 85/1990 Sb., o právu petičním, ve znění pozdějších předpisů.</p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm">
            {[
              ...
              <button key={idx} onClick={link.onClick} className="hover:text-[#a8d08d] transition-colors">
                {link.label}
              </button>
            ))}
          </div>
